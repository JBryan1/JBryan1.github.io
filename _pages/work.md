...
- [Leukemia Classification with Partial Least Squares-Discriminant Analysis ](https://github.com/JBryan1/Daily-Mood-Prediction): Classification of 73 cases of acute lymphoblastic leukemia (ALL) or acute myeloid leukemia (AML) on 7,129 gene expression covariates.
...
- [Heteroskedastic Data Modeling](https://github.com/JBryan1/Daily-Mood-Prediction) A survey of exploratory data analysis methods and statistical approaches to detect and model heteroskedastic data.


- [Robust Regression](https://github.com/JBryan1/Daily-Mood-Prediction): A survey of  divergences from OLS regression assumptions and which robust regression methods are best used to model these divergences for both inference and prediction. 
